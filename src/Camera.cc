...
void Camera::UpdateMV()
{
    ...
    // for this camera, to prepare for the transforms of the scene's
    // triangles. The world coordinates must be xformed into the camera's,
    // located at _x,_y,_z and having the three axis we just calculated
